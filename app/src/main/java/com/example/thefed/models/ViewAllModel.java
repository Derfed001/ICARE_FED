...
public class ViewAllModel {
    ...
    public ViewAllModel(String name, String description, String donateamount, String totalamount, String category, String image_url, String benefitname, String donors, String benefitcontact, String donationperiod) {
        this.name = name;
